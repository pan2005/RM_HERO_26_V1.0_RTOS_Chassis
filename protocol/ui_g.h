...
#define ui_g_Ungroup_AUTO_max_send_count (ui_g_max_send_count[4])
#define ui_g_Ungroup_fire_max_send_count (ui_g_max_send_count[5])
#define ui_g_Ungroup_CAP_max_send_count (ui_g_max_send_count[6])
#define ui_g_Ungroup_TH_current_max_send_count (ui_g_max_send_count[7])
