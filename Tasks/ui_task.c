...
#define CAP_ARC_START_ANGLE 270
#define CAP_ARC_END_ANGLE_MAX 450
...
static int cap_arc_end_angle_from_voltage(float voltage)
{
    ...
    return CAP_ARC_START_ANGLE + (int)(ratio * (CAP_ARC_END_ANGLE_MAX - CAP_ARC_START_ANGLE));
}
...
void UI_Task(void *argument) {
    ...
    while(1) {
        ...
        ui_g_Ungroup_CAP_energy->number = (int32_t)robot_ctrl.referee.robot_status.robot_id;
        ...
        ui_g_Ungroup_CAP_arc->end_angle = cap_arc_end_angle_from_voltage(cap_voltage);
